...
import ProfilePic from "../Assets/Vamsi Susi.png";
    ...
    <div className="work-section-wrapper">
      <div className="work-section-top">
        ...
        <p className="primary-text">
          "Kitchen Kart: Where cravings meet convenience, and flavor is
      ...
      <div className="testimonial-section-bottom">
        ...
        <p>
          Kitchen Kart is an absolute delight! Their wide selection, prompt
